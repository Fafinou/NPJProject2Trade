...
public class Client {
    ...
    static enum CommandName {
        ...
        newAccount, getAccount, deleteAccount, deposit, withdraw, balance, quit, help, list, getAccountName, getNumberOfAccount;
    };
    ...
    void execute(Command command) throws RemoteException, RejectedException {
        ...
        switch (command.getCommandName()) {
            ...
            case quit:
                System.exit(1);
            case getNumberOfAccount:
                System.out.println(bankobj.getNumberOfAccount());
                return;
            case help:
